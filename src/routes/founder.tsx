...
export const Route = createFileRoute("/founder")({
  head: () => ({
    meta: [
      { title: "Srinithin Somasundaram — Founder & CEO | Yesp Corporation" },
      {
        name: "description",
        content:
          "Srinithin Somasundaram is the Founder & CEO of Yesp Corporation. Official headshot, biography, LinkedIn & Instagram links. Rooted in Erode, built in Coimbatore, and operating in Bengaluru for global enterprise software & AI.",
      },
      {
        name: "keywords",
        content:
          "Srinithin Somasundaram, Srinithin, Founder Yesp Corporation, CEO Yesp Corporation, Yesp Founder, Srinithin Photo, Srinithin Headshot, Srinithin LinkedIn, Srinithin Instagram, Erode Coimbatore Bengaluru Technology Leader, Enterprise Software AI Founder",
      },
      { property: "og:title", content: "Srinithin Somasundaram — Founder & CEO | Yesp Corporation" },
      {
        property: "og:description",
        content:
          "Official executive profile and photo of Srinithin Somasundaram, Founder & CEO of Yesp Corporation. Connect on LinkedIn and Instagram.",
      },
      { property: "og:image", content: "https://yespstudio.com/assets/founder-srinithin-somasundaram.png" },
      { property: "og:image:alt", content: "Srinithin Somasundaram — Founder & CEO of Yesp Corporation" },
      { property: "og:type", content: "profile" },
      { name: "twitter:title", content: "Srinithin Somasundaram — Founder & CEO, Yesp Corporation" },
      {
        name: "twitter:description",
        content:
          "Founder profile and press photo for Srinithin Somasundaram. Rooted in Erode, built in Coimbatore, operating in Bengaluru for global clients.",
      },
      { name: "twitter:image", content: "https://yespstudio.com/assets/founder-srinithin-somasundaram.png" },
    ],
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "ProfilePage",
              "@id": "https://yespstudio.com/founder#webpage",
              url: "https://yespstudio.com/founder",
              name: "Srinithin Somasundaram — Founder & CEO | Yesp Corporation",
              description: "Official founder profile page for Srinithin Somasundaram, Founder & CEO of Yesp Corporation.",
              mainEntity: { "@id": "https://yespstudio.com/founder#person" },
              primaryImageOfPage: { "@id": "https://yespstudio.com/founder#image" },
            },
            {
              "@type": "Person",
              "@id": "https://yespstudio.com/founder#person",
              name: "Srinithin Somasundaram",
              alternateName: ["Srinithin", "Srinithin S"],
              ...
              image: {
                "@type": "ImageObject",
                "@id": "https://yespstudio.com/founder#image",
                url: "https://yespstudio.com/assets/founder-srinithin-somasundaram.png",
                caption: "Srinithin Somasundaram — Founder & CEO of Yesp Corporation",
              },
              sameAs: [
              ...
              description:
                "Founder & CEO of Yesp Corporation, an enterprise technology firm specializing in custom software development, artificial intelligence systems, and intelligent workflow automation.",
              homeLocation: {
                "@type": "Place",
            ...
            },
            {
              ...
              "@id": "https://yespstudio.com/founder#image",
              url: "https://yespstudio.com/assets/founder-srinithin-somasundaram.png",
              contentUrl: "https://yespstudio.com/assets/founder-srinithin-somasundaram.png",
              caption: "Srinithin Somasundaram, Founder & CEO of Yesp Corporation",
              description: "Official executive headshot portrait of Srinithin Somasundaram, Founder & CEO of Yesp Corporation.",
            },
            {
              "@type": "Corporation",
              "@id": "https://yespstudio.com/#corporation",
              name: "Yesp Corporation",
              url: "https://yespstudio.com",
              founder: { "@id": "https://yespstudio.com/founder#person" },
              logo: "https://yespstudio.com/assets/yesp-footer-logo.png",
              slogan: "Make Better Happen.",
              description:
                "Enterprise technology company building software, AI systems, and intelligent automation for businesses operating at scale.",
              areaServed: "Global",
              sameAs: [
                "https://www.linkedin.com/in/srinithinsomasundaram/",
                "https://www.instagram.com/srinithin.somasundaram/",
            ...
            },
            {
              ...
              mainEntity: [
                {
                  "@type": "Question",
                  name: "Who is the founder of Yesp Corporation?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Srinithin Somasundaram is the Founder & CEO of Yesp Corporation, an enterprise technology firm building software, AI systems, and intelligent automation for global clients.",
                  },
                },
                {
                  "@type": "Question",
                  name: "Where can I connect with Srinithin Somasundaram online?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "You can connect with Srinithin Somasundaram on LinkedIn (https://www.linkedin.com/in/srinithinsomasundaram/) and Instagram (https://www.instagram.com/srinithin.somasundaram/).",
                  },
                },
                {
                  "@type": "Question",
                  name: "What is Srinithin Somasundaram's core philosophy behind Yesp Corporation?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Srinithin Somasundaram founded Yesp Corporation under the slogan 'Make Better Happen.' The core philosophy is that enterprise technology should simplify operations, eliminate repetitive work, connect fragmented systems, and make businesses faster, smarter, and more scalable.",
                  },
                },
                {
                  "@type": "Question",
                  name: "What is the geographical lineage of Srinithin Somasundaram and Yesp Corporation?",
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "Srinithin Somasundaram and Yesp Corporation are rooted in Erode (foundational values), built in Coimbatore (engineering precision), and operating in Bengaluru (global technology hub) serving international enterprise clients.",
                  },
                },
              ],
            },
